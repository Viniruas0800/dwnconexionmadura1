...
import { X, Crown, Zap, Shield, Gift, CheckCircle, Clock, Play, Phone } from 'lucide-react'
import { useViewportHeight } from "@/hooks/use-viewport-height"
import CreditsDiscountPopup from "./credits-discount-popup"
...
return (
  <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white overflow-x-hidden">
              ...
              <div className="text-center mb-6">
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <span className="text-5xl font-bold text-white">$13,90</span>
                  </div>
    ...
    {/* Credits Discount Popup */}
    <CreditsDiscountPopup
      isOpen={showImportantPopup}
      onClose={() => setShowImportantPopup(false)}
    ...
    <AnimatePresence>
      {showExitIntent && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          // Aqui está a modificação para esconder o popup
          className={`fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 ${true ? "hidden" : ""}`}
        >
          <motion.div
            initial={{ scale: 0.9, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
